...
int main(int argc, char **argv)
{
    char *token = "qwerty_9";
    printf("step 1:\n");
    char *url = "http://edi.iem.pw.edu.pl:30000/worlds/api/v1/worlds/reset/{$token}" ;
    make_request(url);
    printf("step 2:\n");
    //url = argc < 2 ? "http://edi.iem.pw.edu.pl:30000/worlds/api/v1/worlds/info/qwerty_9" : argv[1];
    //make_request(url);
    return 0;
}