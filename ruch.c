...
{
    url = "http://edi.iem.pw.edu.pl:30000/worlds/api/v1/worlds/explore/{@token}";
    make_request(url);
}
int move(char *token)
{
    url = "http://edi.iem.pw.edu.pl:30000/worlds/api/v1/worlds/move/{@token}";
    make_request(url);
}
int rotate_right(char *token)
{
    url = "http://edi.iem.pw.edu.pl:30000/worlds/api/v1/worlds/rotate/{$token}/right";
    make_request(url);
}
int rotatr_left(char *token)
{
    url = "http://edi.iem.pw.edu.pl:30000/worlds/api/v1/worlds/rotate/{$token}/left";
    make_request(url);
}